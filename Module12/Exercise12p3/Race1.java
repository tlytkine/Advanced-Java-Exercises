...
class NewFrame extends JFrame {
	...
	while ( (d1.position < finishLine) && (d2.position < finishLine) ) {
	    ...
	    if (d1Nextwakeup < d2Nextwakeup && (d1Nextwakeup <d3Nextwakeup)) {
		try {
	    ...
	    else if((d2Nextwakeup < d1Nextwakeup) && (d2Nextwakeup <d3Nextwakeup)){
		try {
	    ...
	    else if((d3Nextwakeup < d1Nextwakeup) && (d3Nextwakeup < d2Nextwakeup)) {
	    try {
